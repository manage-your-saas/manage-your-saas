      ...
      <div className="flex-1 flex flex-col lg:ml-72">
        ...
        <main className="flex-1 p-4 md:p-6 lg:p-8">
          <div className="max-w-2xl mx-auto">
            ...
            {/* Security Trust Box */}
            <div className="mb-8 bg-emerald-500/30 border border-border rounded-2xl p-6">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-accent/10 rounded-xl flex items-center justify-center shrink-0">
                  <Shield className="w-6 h-6 text-accent" />
                </div>
                <div>
                  <h3 className="font-semibold mb-2">🔒 Your API Keys Are Safe With Us</h3>
                  <p className="text-sm text-muted-foreground mb-3">
                    Your API keys are encrypted at rest and in transit using industry-standard AES-256.
                    We never share or sell your credentials.
                  </p>
              ...
              {success ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground mb-2">
                    Your API key is securely stored. You’re ready to track revenue.
                  </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 border border-border rounded-xl bg-background focus:outline-none focus:ring-2 focus:ring-accent/50 pr-12"
                        required
                      />
                  ...
                  <button
                    ...
                    className="w-full  hover:bg-accent-hover bg-emerald-600 disabled:text-muted text-white font-medium py-3 px-4 rounded-xl transition flex items-center justify-center gap-2"
                  >
                    {isLoading ? (
                      <>
            ...
            <div className="mt-8 bg-muted/30 rounded-2xl p-6">
              ...
              <div className="bg-amber-500/30 border border-border rounded-xl p-4 mb-4">
              ...
              <ol className="space-y-2 text-sm text-muted-foreground">
                <li>1. Login to your Dodo Payments dashboard</li>
                <li>2. Go to Settings → API Keys</li>
                <li>3. Generate or copy an existing key</li>
                <li>4. Ensure it has read access for revenue data</li>
              </ol>
            </div>
